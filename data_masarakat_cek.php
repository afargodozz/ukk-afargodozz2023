            ...
            <div class="single_slider  d-flex align-items-center slider_bg_2 overlay2">
             ...
             <div class="slider_text ">
                                ...
                                <div class="video_service_btn">
                                    <a href="#" class="btn btn-primarys" style="text-transform: uppercase;"><i class="fa fa-user"></i> <?php echo $_SESSION['nama_petugas']?></a>
                                    <a href="#" class="btn btn-primarys" style="text-transform: uppercase;"><?php echo $_SESSION['level']?></a>
                                </div>
                    </div>
                        </div>
                    </div>
