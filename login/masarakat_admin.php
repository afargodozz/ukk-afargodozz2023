                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text ">
                                ...
                                <p>Selamat datang di web Pengaduan Masyarakat Desa kyyaja Kec. cihamplas<br>
                                    Silahkan adukan Keluh Kesah anda terhadap pemerintahan Desa kyyaja</p>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text ">
                               <h3> Web Pelaporan<br>
                                    Pengaduan Masyarakat</h3>
                                <p>Selamat datang di web Pengaduan Masyarakat Desa kyyaja Kec. Cikeusik<br>
                                    Silahkan adukan Keluh Kesah anda terhadap pemerintahan Desa kyyaja</p>
                                <div class="video_service_btn">
                                    <a href="#" class="boxed-btn3" style="text-transform: uppercase; font-size:15px"><i class="fa fa-user"> <?php echo $_SESSION['nama']?></i></a>
                                    <a href="pengaduan.php" class="boxed-btn3">Pengaduan disini</a>
